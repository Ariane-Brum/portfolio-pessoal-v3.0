...
export const Icon = styled.div`
  ...
  &.iconJS {
    ...
    -webkit-animation: ${iconMove} 3s ease 0.6s infinite alternate;
  ...
  &.iconHTML {
    top: 52px;
    left: 48px;
    -webkit-animation: ${iconMove} 3s ease 2.9s infinite alternate;
  ...
  &.iconCSS {
    top: 48px;
    left: 446px;
    -webkit-animation: ${iconMove} 3s ease 1.9s infinite alternate;
